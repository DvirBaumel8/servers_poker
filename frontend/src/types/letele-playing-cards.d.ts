declare module "@letele/playing-cards" {
  ...
  interface CardProps extends SVGProps<SVGSVGElement> {
    title?: string;
  }
  ...
  // Hearts
  export const Ha: CardComponent; // Ace of Hearts
  ...
  export const Hj: CardComponent; // Jack
  export const Hq: CardComponent; // Queen
  export const Hk: CardComponent; // King
  ...
  // Special cards
  export const J1: CardComponent; // Joker 1
  export const J2: CardComponent; // Joker 2
  export const B1: CardComponent; // Back 1
  export const B2: CardComponent; // Back 2
