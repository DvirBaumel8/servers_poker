...
export const BROWSER_SCENARIOS: BrowserScenario[] = [
  ...
  {
    name: "Quick Bot tier advances to personality step",
    description:
      "Clicking Quick Bot should auto-advance to the Personality step (not stay on tier selection)",
    role: "user",
    critical: true,
    steps: [
      { action: "navigate", url: "/bots/build" },
      { action: "checkNoErrors" },
      { action: "verifyVisible", text: "Choose Complexity Level" },
      { action: "click", text: "Quick Bot" },
      { action: "wait", timeout: 500 },
      { action: "verifyVisible", text: "Personality Sliders" },
      { action: "verifyNotVisible", text: "Choose Complexity Level" },
      { action: "checkNoErrors" },
    ],
  },
  {
    name: "Strategy Builder tier shows rules step",
    description:
      "Clicking Strategy Builder should advance to personality, then Next should show Strategy Rules (not skip to review)",
    role: "user",
    critical: true,
    steps: [
      { action: "navigate", url: "/bots/build" },
      { action: "checkNoErrors" },
      { action: "click", text: "Strategy Builder" },
      { action: "wait", timeout: 500 },
      { action: "verifyVisible", text: "Personality Sliders" },
      { action: "click", text: "Next" },
      { action: "wait", timeout: 500 },
      { action: "verifyVisible", text: "Strategy Rules" },
      { action: "checkNoErrors" },
    ],
  },
  {
    name: "Quick Bot skips rules step",
    description:
      "Quick Bot flow should go tier -> personality -> review (no rules step)",
    role: "user",
    critical: true,
    steps: [
      { action: "navigate", url: "/bots/build" },
      ...
      { action: "click", text: "Next" },
      { action: "wait", timeout: 500 },
      { action: "verifyVisible", text: "Name & Save" },
      { action: "verifyNotVisible", text: "Strategy Rules" },
      { action: "checkNoErrors" },
    ],
  },
  {
